...
L["BlockCompletion"] = "Block completing missions if the character does not have a weekly Anima quest"
L["BlockCompletionErrorNoQuest"] = "TLDRMissions: Missions not completed - this character does not have a weekly Anima quest!"
L["BlockCompletionErrorQuestComplete"] = "TLDRMissions: Missions not completed - this character has already completed its weekly Anima quest!"
