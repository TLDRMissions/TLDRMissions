...
L["MissionsSentPartial"] = "%d отправлено; %d пропущенно; %d failed; %d доступно соратников"
...
L["CompleteMissionsButtonText"] = "Завершить выполненные задания"
...
L["Profiles"] = "Профили"
L["RestoreProfile"] = "Восстановить"
L["DeleteProfile"] = "Удалить"
L["SaveProfile"] = "Сохранить"
